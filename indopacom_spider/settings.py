...
# Scrapy settings for indopacom_spider project
#
...
SPIDER_MODULES = ['indopacom_spider.spiders']
NEWSPIDER_MODULE = 'indopacom_spider.spiders'

# Crawl responsibly by identifying yourself (and your website) on the user-agent
# USER_AGENT = 'indopacom_spider (+http://www.yourdomain.com)'
...
# 指定最长半天之后强制关闭程序
CLOSESPIDER_TIMEOUT = 43200  # 12小时*3600秒 = 43200
...
# SPIDER_MIDDLEWARES = {
#    'indopacom_spider.middlewares.IndopacomSpiderSpiderMiddleware': 543,
# }

# Enable or disable downloader middlewares
# See https://docs.scrapy.org/en/latest/topics/downloader-middleware.html
DOWNLOADER_MIDDLEWARES = {
    'indopacom_spider.middlewares.IndopacomSpiderDownloaderMiddleware': 543,
}
...
ITEM_PIPELINES = {
    'indopacom_spider.pipelines.SaveImagePipeline': 1,
...
MONGO_PWD = '123456'
# 新闻、官网、军演表
MONGO_NEWS_TABLE = 'data_collect_news'
# 听证会表
